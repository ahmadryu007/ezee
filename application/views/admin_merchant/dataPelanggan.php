      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
            <form action="<?php echo $base_url;?>index.php/merchantPelanggan" method="post">
            ...
            <!--  <table id="example1" class="table table-bordered table-striped">
              ...
              <form action="<?php echo $base_url;?>index.php/merchantPelanggan" method="post">
                ...
                <form action="<?php echo $base_url;?>index.php/merchantPelanggan/download_pdf" method="post">
                    ...
                    <a href="<?php echo $base_url;?>index.php/merchantPelanggan/download_csv" class="btn btn-info">
