        ...
        <div class="col-md-3">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h4 class="box-title">Sorot Events</h4>
            </div>
            <div class="box-body">
              <!-- the events -->
              <div id="external-events">
                <div class="external-event bg-green">Makan Siang</div>
                <div class="external-event bg-yellow">Pulang</div>
                <div class="external-event bg-aqua">Coding</div>
                <div class="external-event bg-light-blue">UI design</div>
                <div class="checkbox">
